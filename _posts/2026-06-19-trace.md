...
Soit $V$ et $W$ deux espaces vectoriels, Le produit tensoriel de $V$ par $W$ est un espace vectoriel (on admet qu'il existe et qu'il est unique à isomorphisme près), noté $V \otimes W$, muni dune application bilinéaire canonique

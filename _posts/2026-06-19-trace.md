...
**Approche tensorielle.** Si $V$ est de dimension finie, alors l'identification $V \otimes V^* \cong \mathrm{End}(V)$ n'est plus valable. À la place, $V \otimes V^*$ s'identifie au sous-espace de $\mathrm{End}(V)$ constitué des endomorphismes de rang fini -- pour ces endomorphismes, la notion de trace naïve est encore valable.

Si on souhaite généraliser, il faut tenir compte de la topologie en dimension finie : typiquement, si 
